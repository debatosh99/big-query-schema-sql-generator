...
#WAREHOUSE_PATH = "gs://learnbiglakeiceberg20/"
...
namespace = "iceberg_rest_catalog_fed_namespace20"
table_identifier = f"{namespace}.customer_details_pyiceberg_created"

print(f"namespaces present :{catalog.list_namespaces()}")
...
try:
    ...
    table = catalog.create_table_if_not_exists(
        ...
        schema=schema,
        location=f"{WAREHOUSE_PATH}{namespace}/customer_details_pyiceberg_created"
    )
