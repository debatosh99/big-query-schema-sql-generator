...
from standalone_agent_workflow import ResponseFormat
...
class CurrencyAgent:
    ...
    def __init__(self):
        self.llm = ChatOpenAI(
                    model_name="google/gemini-2.0-flash-exp:free",  # Choose your desired model from OpenRouter
        ...
        from standalone_agent_workflow import graph_builder
